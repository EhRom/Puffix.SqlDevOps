...
$childCertificateName = "CN=AzureP2S$($baseName)_$($childName)"
...
Try {
    ...
    $childCertificate =  New-SelfSignedCertificate -Type Custom -DnsName AzureP2S_VPN_AKU -KeySpec Signature `
