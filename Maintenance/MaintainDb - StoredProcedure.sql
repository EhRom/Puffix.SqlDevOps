-- Stored procedure used to maintain the indexes and statistics in your database.
-- You can automate its execution via a SQL Agent Job.
IF OBJECT_ID(N'[dbo].[MaintainDb]') IS NULL
	EXEC('CREATE PROCEDURE [dbo].[MaintainDb] AS SELECT 1;');
GO
